try {
    ...
    #--Add Gif file
    $file = (get-item "C:\Users\DelaCruzMar\OneDrive - FUJITSU\Desktop\Day 4 Assignment\guo2.gif")
    $file2 = (get-item "C:\Users\DelaCruzMar\OneDrive - FUJITSU\Desktop\Day 4 Assignment\OIP.jpg")
    $IconImage = New-Object system.drawing.icon ("C:\Users\DelaCruzMar\OneDrive - FUJITSU\Desktop\Day 4 Assignment\Files-icon (1).ico")
    ...
    $btnStart.Add_Click({
        ...
         If ($objTypeCheckbox.Checked -eq $true)
        {
           ...
           $vartest = "True"
           $json | ConvertTo-Json | Out-File "C:\Users\DelaCruzMar\OneDrive - FUJITSU\Desktop\Day 4 Assignment\ClassA-Toolbox\script"
        }
